...
const ToolIcons = {
  Premiere: () => (
    <svg viewBox="0 0 240 234" className="w-full h-full">
      ...
      <path fill="#9999FF" d="M100 121.5c3.7-2.3 5.7-6.1 5.7-10.5 0-8.6-5.8-14-16-14H62v68h12V130h14.9l14.4 35h13.2l-16.5-37.5c3.3-1 6-3 8-6zm-26-12.5V87h14.8c5.3 0 8.2 2.6 8.2 7 0 4.4-2.8 7-8.2 7H74zM134 96v-9h-12v68h12v-35.5c0-10.7 5.5-16.5 15.5-16.5 1.8 0 3.6.2 5.5.6V94.6c-1.5-.3-2.7-.5-3.7-.5-8.8 0-14.7 5.5-17.3 13.9V96z"/>
    </svg>
  ),
  Photoshop: () => (
    <svg viewBox="0 0 240 234" className="w-full h-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          {tools.map((tool, index) => {
            ...
            return (
              ...
              >
                <div className={`w-24 h-24 bg-gradient-to-br ${tool.color} rounded-2xl p-4 shadow-lg hover:shadow-2xl transition-all mb-4 flex items-center justify-center`}>
